...
class Rectangle:
    ...
    def __str__(self):
        """Devuelve una representación del rectángulo con '#'.
    ...
    def __repr__(self):
        """Devuelve una representacion en cadena del rectángulo.

        El formato permite la creación de un nuevo objeto con eval().
        """
        return f"Rectangle({self.__width}, {self.__height})"

    def __del__(self):
        """Imprime cuando una instancia de Rectangle se elimina."""
        print("Bye rectangle...")
        Rectangle.number_of_instances -= 1
