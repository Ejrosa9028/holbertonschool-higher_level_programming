...
class Square:
    ...
    def __init__(self, size=0, position=(0, 0)):
        ...
        Raises:
            TypeError: Si el tamaño no es un número entero o si la posición no es una tupla de 2 enteros positivos.
            ValueError: Si el tamaño es menor que 0 o si los elementos de la tupla de posición no son enteros positivos.
        """
        self.size = size
    ...
    def my_print(self):
        ...
        La posición se utiliza para agregar espacios antes de dibujar el cuadrado.
        """
        if self.__size == 0:
            print("")
        else:
