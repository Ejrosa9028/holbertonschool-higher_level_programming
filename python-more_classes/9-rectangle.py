...
class Rectangle:
    ...
    def __str__(self):
        """Devuelve una representación en cadena del rectángulo usando `print_symbol`."""
        if self.__width == 0 or self.__height == 0:
            return ""
        return "\n".join([str(self.print_symbol) * self.__width] * self.__height)

    def __repr__(self):
        """Devuelve una representación en cadena que puede ser usada con eval() para recrear el rectángulo."""
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Returns:
            Rectangle: El rectángulo con el área mayor, o el primero en caso de empate.
        
        Raises:
            TypeError: Si cualquiera de los objetos no es una instancia de Rectangle.
        """
    ...
    def square(cls, size=0):
        """Devuelve una nueva instancia de Rectangle donde el ancho y alto son iguales.
