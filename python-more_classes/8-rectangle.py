...
class Rectangle:
    ...
    def __init__(self, width=0, height=0):
        """Inicializa un nuevo rect con el ancho y alto dados.

        Args:
            width (int): El ancho del rect (por defecto es 0).
            height (int): El alto del rect (por defecto es 0).
        """
        self.width = width
        self.height = height
    ...
    def __str__(self):
        """Devuelve rectángulo usando `print_symbol`."""
        if self.__width == 0 or self.__height == 0:
            return ""
        return "\n".join([str(self.print_symbol)*self.__width]*self.__height)

    def __repr__(self):
        """Devuelve eval() para recrear el rectángulo."""
        return f"Rectangle({self.__width}, {self.__height})"

    def __del__(self):
        """Imprime un mensaje del rectángulo es eliminada."""
        print("Bye rectangle...")
        Rectangle.number_of_instances -= 1
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Returns:
            Rectangle: El rectángulo área mayor, o el caso de empate.

        Raises:
            TypeError: Si cualquiera de los objetos no es de Rectangle.
        """
