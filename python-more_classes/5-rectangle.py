...
class Rectangle:
    ...
    def __init__(self, width=0, height=0):
        """Inicializa un nuevo rectángulo con un ancho y alto dados.
    ...
    def __str__(self):
        """Devuelve una representación en cadena del rectángulo con '#'.
    ...
    def __repr__(self):
        """Devuelve una representación oficial en cadena del rectángulo.

        El formato de la cadena debe permitir la creación de un nuevo objeto con eval().
        """
        return f"Rectangle({self.__width}, {self.__height})"

    def __del__(self):
        """Imprime el mensaje cuando una instancia de Rectangle se elimina."""
        print("Bye rectangle...")
